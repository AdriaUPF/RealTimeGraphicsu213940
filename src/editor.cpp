...
void SceneEditor::inspectEntity(SCN::BaseEntity* entity)
{
	...
	//ImGui::SliderFloat("Shininess", &entity->s_selected->root.material->shinyness, 0.0, 100.0);
...
void SceneEditor::inspectObject(SCN::Material* material)
{
	...
	ImGui::SliderFloat("Shininess", &material->shinyness, 0.0, 100.0); //I dont understan why, my shinines goes backward in my phong model
